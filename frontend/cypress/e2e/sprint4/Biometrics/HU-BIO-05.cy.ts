describe('User can view the graphic data of its heart rate through the history of biometric sessions', () => {
  it('User can view the graphic data of its heart rate through the history of biometric sessions', () => {
    ...
    cy.contains('button', 'Heart Rate').click();
