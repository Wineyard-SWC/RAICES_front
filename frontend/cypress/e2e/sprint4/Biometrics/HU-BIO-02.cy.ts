describe('User can view the graphic data of its stress levels through the history of biometric sessions', () => {
  it('User can view the graphic data of its stress levels through the history of biometric sessions', () => {
