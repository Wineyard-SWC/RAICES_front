describe('User can view the graphic data of its energy levels through the history of biometric sessions', () => {
  it('User can view the graphic data of its energy levels through the history of biometric sessions', () => {
    ...
    cy.contains('button', 'Energy Level').click();
    ...
    cy.get('div[title*="Session"]')
      ...
      .each(($bar, index) => {
        cy.wrap($bar)
          .should('have.css', 'background-color', 'rgb(245, 158, 11)')
