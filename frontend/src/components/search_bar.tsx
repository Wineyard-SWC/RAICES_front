    ...
    <div className="flex flex-col md:flex-row gap-6 my-6">
      <form onSubmit={handleSearch} className="relative flex-1">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 border border-[#4a2b4a] rounded-md focus:outline-none focus:ring-2 focus:ring-[#4a2b4a] bg-white"
          value={searchQuery}
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <div className="relative">
          <button
            className="flex items-center px-4 py-2 border border-[#4a2b4a] rounded-md bg-white w-full md:w-auto justify-between"
