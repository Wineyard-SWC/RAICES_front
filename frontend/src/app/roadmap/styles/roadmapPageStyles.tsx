export const roadmapPageStyles = {
  // Container principal - aumentar anchura para ser consistente con dashboard
  container: "min-h-screen bg-gray-50",
  canvasWrapper: "w-full mx-auto p-6 max-w-none", // Cambio aquí: remover limitación de ancho
  
  // Estado vacío - hacer más ancho para ser consistente
  emptyStateWrapper: "max-w-full mx-auto bg-white rounded-lg shadow-sm border border-gray-200 p-8", // Cambio aquí: de max-w-6xl a max-w-full
  emptyStateInner: "w-full mx-auto",
  
  // Header - mantener centrado pero sin limitar ancho del contenedor padre
  ...
  subtitle: "text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8", // Aumentar ancho máximo del subtítulo
  ...
  // Grid de contenido - hacer más responsivo y ancho
  ...
  // Elementos específicos - mantener igual
